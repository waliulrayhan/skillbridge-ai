    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Empowering Education for Career Success
          </motion.h1>
          ...
          >
            Bridge the gap between education and employment with personalized learning paths and job matching.
          </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-16">Why Choose SkillBridge AI?</h2>
...
const features = [
  {
    ...
    description: "AI-driven course recommendations tailored to your career goals and skill level.",
  ...
  },
  {
    ...
    description: "Earn industry-recognized certifications to validate your skills and knowledge.",
